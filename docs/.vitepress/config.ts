...
const domain = getCommandLineArgs()['domain'] as string;
...
export default defineConfig({
        ...
        zh: {
            ...
            themeConfig: {
                ...
                nav: [
                    ...
                    {text: '在线演示', link: domain + '/zh/demo/index.html', target: "_self", rel: "", noIcon: true},
                    {text: '价格', link: domain + '/zh/price/index.html', target: "_self", rel: "", noIcon: true},
                    {
                        text: '联系我们',
                        link: domain + '/zh/contact-us/index.html',
                        target: "_self",
                        rel: "",
                        noIcon: true
                    },
                ...
                sidebar: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            {text: '行高', link: '/zh/config/lineHeight'},
    ...
    themeConfig: {
        ...
        nav: [
            ...
            {text: 'Demo', link: domain + '/demo/index.html', target: "_self", rel: "", noIcon: true},
            {text: 'Price', link: domain + '/price/index.html', target: "_self", rel: "", noIcon: true},
            {text: 'Contact Us', link: domain + '/contact-us/index.html', target: "_self", rel: "", noIcon: true},
...
})(window,document,'script','dataLayer','GTM-W2PD2F7J');`
        ],
